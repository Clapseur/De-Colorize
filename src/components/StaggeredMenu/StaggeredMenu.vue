      ...
      >
        ...
        >
          ...
          >
            <span
              ref="textInnerRef"
              class="flex flex-col leading-none sm-toggle-textInner"
            >
              <span
...
const props = withDefaults(defineProps<StaggeredMenuProps>(), {
  ...
  logoUrl: "/src/assets/full_noir.png",
  menuButtonColor: "#fff",
...
const animateColor = (opening: boolean) => {
  ...
  if (props.changeMenuColorOnOpen) {
    const targetColor = opening
      ? props.openMenuButtonColor
      : props.menuButtonColor;
...
watch(
  ...
  () => {
    if (toggleBtnRef.value) {
      if (props.changeMenuColorOnOpen) {
        const targetColor = openRef.value
          ? props.openMenuButtonColor
          : props.menuButtonColor;
